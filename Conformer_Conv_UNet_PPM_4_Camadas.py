...
#     valor_1_skip,valor_1=conformerConvModule(entered_input, filters,1)
#     valor_2_skip,valor_2=conformerConvModule(entered_input, filters,3)
#     valor_3_skip,valor_3=conformerConvModule(entered_input, filters,7)
#     valor_4_skip,valor_4=conformerConvModule(entered_input, filters,11)
    
#     merged = layers.concatenate([valor_1, valor_2, valor_3, valor_4], axis=-1)
    
#     merged_skip = layers.concatenate([valor_1_skip, valor_2_skip, valor_3_skip, valor_4_skip], axis=-1)

#     enc1 = convolution_block(merged, filters) 
    
#     MaxPool1 = MaxPooling2D(pool_size=(2, 2), strides=(2, 2))(enc1)
#     print("skip",merged_skip)
#     print("camada",MaxPool1)

#     return MaxPool1, merged_skip 

from tensorflow.keras.layers import Flatten, Reshape

def merge_PPM(entered_input, filters=48):
    out_1 = conformerConvModule(entered_input, filters, 1)
    out_3 = conformerConvModule(entered_input, filters, 3)
    out_7 = conformerConvModule(entered_input, filters, 7)
    out_11 = conformerConvModule(entered_input, filters, 11)
